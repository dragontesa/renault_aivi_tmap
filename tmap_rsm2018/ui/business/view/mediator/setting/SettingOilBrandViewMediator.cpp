#include "SettingOilBrandViewMediator.h"
...
SettingOilBrandViewMediator::SettingOilBrandViewMediator( QObject* viewComponent )
    : AbstractViewMediator( viewComponent ),
      mChanged(false)
{
}

QList<int> SettingOilBrandViewMediator::listNotificationInterests()
{
...
bool SettingOilBrandViewMediator::onEvent( int event, const QVariant& data )
{
    T_DEBUGV( "event: %d", event );

    switch ( event ) {
    case Activated: {
            sendNotification(ZoneConstants::RegistSoftkey, ViewRegistry::objectName(ViewRegistry::SettingOilBrandView));
    ...
    case SaveSetting: {
            ...
            sendNotification(SettingConstants::SavedSettingFromObjectName, ViewRegistry::objectName(ViewRegistry::SettingOilBrandView));
...
bool SettingOilBrandViewMediator::handleNotification( const mvc::INotificationPtr& note )
{
    switch ( note->getId() ) {
    case SettingConstants::ApplySetting:
        {
            ...
            if ( section == SettingConstants::SearchOption  ) {
    ...
    case ZoneConstants::DoSoftkeyIndexMenuFunction:{
            ...
            if (objectName != ViewRegistry::objectName(ViewRegistry::SettingOilBrandView))
                return false;
