#include "SettingVoiceGuidTimeViewMediator.h"
...
SettingVoiceGuidTimeViewMediator::SettingVoiceGuidTimeViewMediator( QObject* viewComponent )
    : AbstractViewMediator( viewComponent ),
    mChanged(false)
{
}

QList<int> SettingVoiceGuidTimeViewMediator::listNotificationInterests()
{
...
bool SettingVoiceGuidTimeViewMediator::onEvent( int event, const QVariant& data )
{
    T_DEBUGV( "event: %d", event );

    switch ( event ) {
    case Activated: {
            sendNotification(ZoneConstants::RegistSoftkey, ViewRegistry::objectName(ViewRegistry::SettingVoiceGuidTimeView));
...
bool SettingVoiceGuidTimeViewMediator::handleNotification( const mvc::INotificationPtr& note )
{
    switch ( note->getId() ) {
    case SettingConstants::ApplySetting: {
            ...
            if ( section == SettingConstants::GuidSubVoiceGuidTime) {
    ...
    case ZoneConstants::DoSoftkeyIndexMenuFunction:{
            ...
            if (objectName != ViewRegistry::objectName(ViewRegistry::SettingVoiceGuidTimeView))
                return false;
