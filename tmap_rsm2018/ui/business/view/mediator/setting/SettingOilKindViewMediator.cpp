#include "SettingOilKindViewMediator.h"
...
SettingOilKindViewMediator::SettingOilKindViewMediator( QObject* viewComponent )
    : AbstractViewMediator( viewComponent ),
      mChanged(false)
{
}

QList<int> SettingOilKindViewMediator::listNotificationInterests()
{
...
bool SettingOilKindViewMediator::onEvent( int event, const QVariant& data )
{
    T_DEBUGV( "event: %d", event );

    switch ( event ) {
    case Activated: {
            sendNotification(ZoneConstants::RegistSoftkey, ViewRegistry::objectName(ViewRegistry::SettingOilKindView));
    ...
    case SaveSetting: {
            ...
            sendNotification(SettingConstants::SavedSettingFromObjectName, ViewRegistry::objectName(ViewRegistry::SettingOilKindView));
        }
        break;
    case CloseView:
...
bool SettingOilKindViewMediator::handleNotification( const mvc::INotificationPtr& note )
{
    switch ( note->getId() ) {
    ...
    case ZoneConstants::DoSoftkeyIndexMenuFunction:{
            ...
            if (objectName != ViewRegistry::objectName(ViewRegistry::SettingOilKindView))
                return false;
