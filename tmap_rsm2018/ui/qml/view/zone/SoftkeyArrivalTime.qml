...
Item {
    ...
    Item {
        ...
        function updateAmPm(h) {
            if (isAmPm) {
                if (h < 12) {
                    _dayNightText.source = langKo ? Resource.imageUrl("zone/drive_num_day.png")
                                                        : Resource.imageUrl("zone/drive_num_day_eng.png")
                } else {
                    _dayNightText.source = langKo ? Resource.imageUrl("zone/drive_num_night.png")
                                                        : Resource.imageUrl("zone/drive_num_night_eng.png")
                }
            }
        }
        ...
        Row {
            ...
            Image {
                source: Resource.imageUrl("zone/drive_num_colon.png")
            }
            Image {
                id: _10m
            }
