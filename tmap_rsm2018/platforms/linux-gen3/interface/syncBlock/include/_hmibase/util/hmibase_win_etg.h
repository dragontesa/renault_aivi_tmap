...
#ifndef WIN32
#error "include hmibase_win_etg.h for windows only"
#endif
...
#elif defined(WIN32_DEBUG_TO_STDOUT) || defined(WIN32_RELEASE_TO_STDOUT) || defined(VARIANT_S_FTR_ENABLE_ETG_PRINTF)

#define _ETG_TRACE_STD__DEBUG(args, ...)               printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_STD__INFO(args, ...)                printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_STD__WARN(args, ...)                printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_STD__ERROR(args, ...)               printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_STD__FATAL(args, ...)               printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_DCL__DEBUG(TraceClass,args, ...)    printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_DCL__INFO(TraceClass,args, ...)     printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_DCL__WARN(TraceClass,args, ...)     printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_DCL__ERROR(TraceClass,args, ...)    printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_DCL__FATAL(TraceClass,args, ...)    printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_CLS__DEBUG(TraceClass,args, ...)    printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_CLS__INFO(TraceClass,args, ...)     printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_CLS__WARN(TraceClass,args, ...)     printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_CLS__ERROR(TraceClass,args, ...)    printf(args##"\n", ## __VA_ARGS__)
#define _ETG_TRACE_CLS__FATAL(TraceClass,args, ...)    printf(args##"\n", ## __VA_ARGS__)
#define  etg_bIsTraceActive(u16CompID, u16LevelId)     (u16LevelId>=0)
...
#define ETG_TRACE_ERRMEM_THR(printfArgs)                                         // not supportet for WIN32
#define ETG_TRACE_ERRMEM_CLS_THR(u16TraceClass_PrintfArgs)                       // not supportet for WIN32
#define ETG_TRACE_ERRMEM_THR_DCL(u16DerivedClass_printfArgs)                     // not supportet for WIN32
#define ETG_TRACE_ERRMEM_CLS_THR_DCL(u16DerivedClass_u16TraceClass_PrintfArgs)   // not supportet for WIN32

#define ETG_TRACE_FATAL_THR(printfArgs)                                          // not supportet for WIN32
#define ETG_TRACE_FATAL_CLS_THR(u16TraceClass_PrintfArgs)                        // not supportet for WIN32
#define ETG_TRACE_FATAL_THR_DCL(u16DerivedClass_printfArgs)                      // not supportet for WIN32
#define ETG_TRACE_FATAL_CLS_THR_DCL(u16DerivedClass_u16TraceClass_PrintfArgs)    // not supportet for WIN32

#define ETG_TRACE_ERR_THR(printfArgs)                                            // not supportet for WIN32
#define ETG_TRACE_ERR_CLS_THR(u16TraceClass_PrintfArgs)                          // not supportet for WIN32
#define ETG_TRACE_ERR_THR_DCL(u16DerivedClass_printfArgs)                        // not supportet for WIN32
#define ETG_TRACE_ERR_CLS_THR_DCL(u16DerivedClass_u16TraceClass_PrintfArgs)      // not supportet for WIN32

#define ETG_TRACE_SYS_MIN_THR(printfArgs)                                        // not supportet for WIN32
#define ETG_TRACE_SYS_MIN_CLS_THR(u16TraceClass_PrintfArgs)                      // not supportet for WIN32
#define ETG_TRACE_SYS_MIN_THR_DCL(u16DerivedClass_printfArgs)                    // not supportet for WIN32
#define ETG_TRACE_SYS_MIN_CLS_THR_DCL(u16DerivedClass_u16TraceClass_PrintfArgs)  // not supportet for WIN32

#define ETG_TRACE_SYS_THR(printfArgs)                                            // not supportet for WIN32
#define ETG_TRACE_SYS_CLS_THR(u16TraceClass_PrintfArgs)                          // not supportet for WIN32
#define ETG_TRACE_SYS_THR_DCL(u16DerivedClass_printfArgs)                        // not supportet for WIN32
#define ETG_TRACE_SYS_CLS_THR_DCL(u16DerivedClass_u16TraceClass_PrintfArgs)      // not supportet for WIN32

#define ETG_TRACE_COMP_THR(printfArgs)                                           // not supportet for WIN32
#define ETG_TRACE_COMP_CLS_THR(u16TraceClass_PrintfArgs)                         // not supportet for WIN32
#define ETG_TRACE_COMP_THR_DCL(u16DerivedClass_printfArgs)                       // not supportet for WIN32
#define ETG_TRACE_COMP_CLS_THR_DCL(u16DerivedClass_u16TraceClass_PrintfArgs)     // not supportet for WIN32

#define ETG_TRACE_USR1_THR(printfArgs)                                           // not supportet for WIN32
#define ETG_TRACE_USR1_CLS_THR(u16TraceClass_PrintfArgs)                         // not supportet for WIN32
#define ETG_TRACE_USR1_THR_DCL(u16DerivedClass_printfArgs)                       // not supportet for WIN32
#define ETG_TRACE_USR1_CLS_THR_DCL(u16DerivedClass_u16TraceClass_PrintfArgs)     // not supportet for WIN32

#define ETG_TRACE_USR2_THR(printfArgs)                                           // not supportet for WIN32
#define ETG_TRACE_USR2_CLS_THR(u16TraceClass_PrintfArgs)                         // not supportet for WIN32
#define ETG_TRACE_USR2_THR_DCL(u16DerivedClass_printfArgs)                       // not supportet for WIN32
#define ETG_TRACE_USR2_CLS_THR_DCL(u16DerivedClass_u16TraceClass_PrintfArgs)     // not supportet for WIN32

#define ETG_TRACE_USR3_THR(printfArgs)                                           // not supportet for WIN32
#define ETG_TRACE_USR3_CLS_THR(u16TraceClass_PrintfArgs)                         // not supportet for WIN32
#define ETG_TRACE_USR3_THR_DCL(u16DerivedClass_printfArgs)                       // not supportet for WIN32
#define ETG_TRACE_USR3_CLS_THR_DCL(u16DerivedClass_u16TraceClass_PrintfArgs)     // not supportet for WIN32

#define ETG_TRACE_USR4_THR(printfArgs)                                           // not supportet for WIN32
#define ETG_TRACE_USR4_CLS_THR(u16TraceClass_PrintfArgs)                         // not supportet for WIN32
#define ETG_TRACE_USR4_THR_DCL(u16DerivedClass_printfArgs)                       // not supportet for WIN32
#define ETG_TRACE_USR4_CLS_THR_DCL(u16DerivedClass_u16TraceClass_PrintfArgs)     // not supportet for WIN32
