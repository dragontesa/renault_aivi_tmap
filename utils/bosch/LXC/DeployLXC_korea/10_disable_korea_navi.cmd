...
@echo disble Korea navigation firstly
...
putty\plink.exe -batch root@172.17.0.1 mv /opt/bosch/base/bin/NavigationHall_ext_korea_logConfig.json /opt/bosch/base/bin/NavigationHall_ext_korea_original_logConfig.json
...
if not errorlevel 0 goto ERROREXIT
rem putty\plink.exe -batch root@172.17.0.1 reboot -f
