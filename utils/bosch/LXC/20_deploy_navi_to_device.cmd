...
putty\plink.exe -batch root@172.17.0.1 mkdir -p /opt/bosch/extnav/bin
...
putty\pscp -batch -r thirdpartynavi\thirdpartynavigation_out.out root@172.17.0.1:/opt/bosch/extnav/bin/thirdpartynavigation_out.out
if not errorlevel 0 goto ERROREXIT
...
if not errorlevel 0 goto ERROREXIT
putty\plink.exe -batch root@172.17.0.1 chmod +x /opt/bosch/extnav/bin/thirdpartynavigation_out.out
if not errorlevel 0 goto ERROREXIT
